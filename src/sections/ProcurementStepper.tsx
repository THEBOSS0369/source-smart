          ...
          <div className="lg:sticky lg:top-20 lg:h-fit">
            <div className="space-y-6">
              <h2 className="text-5xl md:text-6xl font-medium tracking-tighter">
                Whether it's{" "}
                <span className="bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(30,64,175,.5))] bg-clip-text text-transparent">
            ...
            {PROCESS_STEPS.map((step, index) => {
              if (index <= currentStep) {
                return (
                  ...
                  >
                    <div className="border border-white/20 p-8 rounded-xl w-full max-w-md bg-white/5 backdrop-blur-sm">
