...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-5 lg:px-20 relative mt-16">
        ...
        <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">
          Our AI finds better suppliers, negotiates lower prices, and cuts your
          procurement time by 90%. While you sleep.
        </p>
